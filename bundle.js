...
/***/ function(module, exports, __webpack_require__) {
	...
	var _calculate = __webpack_require__(163);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function setData(data) {
	      var ref = (0, _calculate.setCase)(this.state.history, data);
	      this.setState({
	        history: [].concat(_toConsumableArray(this.state.history), [data]),
	        currentData: data,
	    ...
	    key: 'addRound',
	    value: function addRound(ref, correct, rounds) {
	      rounds[0] = ref;
	      rounds.push(correct);
	      return rounds;
	    }
	    ...
	    key: 'checkAnswer',
	    value: function checkAnswer(data, cases) {
	      if (cases[0] === '-') {
	        return [];
	      } else {
	        return cases.reduce(function (prev, current) {
	          if (current === data) {
	            prev.push('/');
	          } else {
	            prev.push('X');
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'container' },
	        _react2.default.createElement(_Header2.default, { currentData: this.state.currentData }),
	        _react2.default.createElement(_Table2.default, { rounds: this.state.rounds, currentData: this.state.currentData }),
	        _react2.default.createElement(_Button2.default, { setData: this.setData })
	      );
	    }
	  }]);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'button',
	          { onClick: this.props.setData.bind(this, 'R'), className: 'btn red' },
	          'RED'
	        ),
	        _react2.default.createElement(
	          'button',
	          { onClick: this.props.setData.bind(this, 'B'), className: 'btn blue' },
	          'BLUE'
	        )
	      );
	    }
	          ...
	          rounds.map(function (round, index) {
	            return index === 0 ? _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                'tr',
	                { key: index },
	                round.map(function (data, index) {
	                  return _react2.default.createElement(
	                    'td',
	                    { key: index + data, className: data === 'R' ? 'red' : 'blue' },
	                    data
	                  );
	                })
	              )
	              ...
	              _react2.default.createElement(
	                ...
	                round.map(function (data, index) {
	                  return _react2.default.createElement(
	                    'td',
	                    { key: index + data, className: data === '/' ? 'correct' : 'wrong' },
	                    data
	                  );
	                })
	              )
...
/***/ function(module, exports) {
	...
	function setCase(h, data) {
	  var history = [].concat(_toConsumableArray(h), [data]);
	  var len = history.length;
	  if (len == 1) {
	    var _data = history[0];
	    var data2 = _data === 'R' ? 'B' : 'R';
	    return [_data, data2, '-', '-'];
	  } else {
	    var _data2 = history[len - 1];
	    var _data3 = _data2 === 'R' ? 'B' : 'R';
	    var data3 = history[len - 2];
	    var data4 = data3 === 'R' ? 'B' : 'R';
	    return [_data2, _data3, data3, data4];
	  }
	}
